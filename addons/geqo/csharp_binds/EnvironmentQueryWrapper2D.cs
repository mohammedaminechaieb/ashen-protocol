...
public partial class EnvironmentQueryWrapper2D(Node node)
{
    ...
    {
        get => (Node2D)(GodotObject)node.Call(MethodName.GetQuerier);
    ...
    public QueryResultWrapper2D GetResult() => new QueryResultWrapper2D((RefCounted)(GodotObject)node.Call(MethodName.GetResult));
